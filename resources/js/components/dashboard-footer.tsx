...
export default function Dashboardfooter() {
    return (
        <footer className="flex flex-col items-center justify-center gap-2 border-t-2 py-2">
            <div className="flex flex-row items-center justify-between gap-2 border-none p-2 font-bold text-foreground">
                <Link href="/">home</Link>
            ...
            <div className="flex flex-row items-center justify-center gap-4 border-none p-0">
                <div className="bg-primary flex h-[40px] w-[40px] items-center justify-center rounded-full bg-[#ff8c39]">
